...
const WorkplaceApp = () => {
  // Updated functions for navigation on onboarding view to clear error messages
  ...
  // Email Sign-In with empty input check
  const handleEmailSignIn = async () => {
    ...
    try {
      ...
      if (error.code === "auth/user-not-found") {
        setErrorMessage("Account doesn't exist. Please create an account.");
      } else {
